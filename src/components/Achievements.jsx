...
const Achievements = () => {
  ...
  return (
    <section id="achievements" className="py-24 relative bg-warm-ambient bg-dot-pattern">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div
          ...
          className="mb-12 warm-card p-6 sm:p-8 rounded-3xl flex flex-col md:flex-row items-center justify-between gap-6 shadow-lg border-2 border-[#8B5CF6]"
        >
          <div className="flex items-center space-x-5">
            <div className="w-14 h-14 rounded-2xl bg-[#8B5CF6]/20 border border-[#8B5CF6] flex items-center justify-center text-[#EC4899] shrink-0 shadow-[0_0_20px_rgba(139,92,246,0.35)]">
              <Flame size={32} className="animate-pulse" />
            </div>
            <div>
              <span className="px-3 py-0.5 rounded-full bg-[#070A18] border border-[#1F2442] text-[#EC4899] font-sans text-xs font-bold uppercase tracking-wider mb-1 inline-block">
                JAVA PROBLEM SOLVING
              </span>
              <h3 className="text-2xl font-display font-bold text-[#F8FAFC]">
                {achievements.leetcodeStreak.title}
              </h3>
              <p className="text-xs sm:text-sm text-[#CBD5E1] mt-1 font-sans font-normal">
            ...
            >
              <div className="space-y-4">
                <div className="flex items-center justify-between border-b border-[#1F2442] pb-3">
                  <span className="text-xs font-sans font-bold text-[#EC4899] uppercase tracking-wider">
                    {h.tag}
                  </span>
                ...
                <div>
                  <h4 className="text-xl font-display font-extrabold text-[#F8FAFC] group-hover:text-[#EC4899] transition-colors">
                    {h.title}
                  </h4>
                  <div className="text-xs font-sans font-bold text-[#CBD5E1] mt-1">
                    {h.organization}
                  </div>
                </div>

                <p className="text-xs sm:text-sm text-[#CBD5E1] leading-relaxed font-sans font-normal">
                  {h.desc}
                </p>
              </div>
              ...
              {h.images && h.images.length > 0 && (
                <div className="pt-4 border-t border-[#1F2442] space-y-2">
                  <div className="text-[11px] font-sans font-bold text-[#94A3B8] uppercase tracking-wider">
                    ...
                    {h.images.map((img, iIdx) => {
                      ...
                      return (
                        <div
                          ...
                          className="group/img relative rounded-xl overflow-hidden border border-[#1F2442] hover:border-[#8B5CF6] bg-[#070A18] w-24 h-20 shrink-0 cursor-pointer shadow-xs transition-all"
                        >
                          <img
                            src={url}
                            alt={label}
                          ...
                          />
                          <div className="absolute inset-0 bg-[#070A18]/50 opacity-0 group-hover/img:opacity-100 transition-opacity flex items-center justify-center">
                            <Eye size={16} className="text-[#F8FAFC]" />
                          </div>
                        </div>
                      );
                    })}
