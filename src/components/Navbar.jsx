      ...
      <div className="max-w-7xl mx-auto">
        <div
          className={`mx-auto rounded-full transition-all duration-300 ${
            scrolled
              ? 'bg-[#0B0D1A]/90 backdrop-blur-md border border-[#1F2442] shadow-lg py-2.5 px-6'
              : 'bg-[#0B0D1A]/70 backdrop-blur-sm border border-[#1F2442]/70 py-3 px-6'
          }`}
        >
          <div className="flex items-center justify-between">
            ...
            >
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[10px] font-sans text-[#CBD5E1] tracking-wide font-medium">
                  B.Tech IT • SKCT
                </span>
              </div>
            </a>
            ...
            <nav className="hidden lg:flex items-center space-x-1 bg-[#070A18]/80 border border-[#1F2442] rounded-full px-3 py-1.5 backdrop-blur-md">
              {navLinks.map((link) => {
                  ...
                  <a
                    ...
                    className={`px-3.5 py-1 rounded-full text-xs font-semibold transition-all duration-200 ${
                      isActive
                        ...
                        : 'text-[#CBD5E1] hover:text-[#F8FAFC] hover:bg-[#8B5CF6]/15'
                    }`}
                  >
                    {link.name}
                  </a>
            ...
            <div className="flex lg:hidden items-center space-x-2">
              <button
                ...
                className="p-2 rounded-lg text-[#F8FAFC]"
